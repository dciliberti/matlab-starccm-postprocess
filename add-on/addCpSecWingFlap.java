...
public class addCpSecWingFlap extends StarMacro {
  ...
  private void execute0() {
	...
	Boundary flap = 
      fluidDomain.getBoundaryManager().getBoundary("Flap");
    Boundary flapTe = 
      fluidDomain.getBoundaryManager().getBoundary("Flap_TE");
    Boundary wing = 
	...
	planeSection_0.getInputParts().setObjects(flap, flapTe, wing, wingTe);
	planeSection_1.getInputParts().setObjects(flap, flapTe, wing, wingTe);
	planeSection_2.getInputParts().setObjects(flap, flapTe, wing, wingTe);
	planeSection_3.getInputParts().setObjects(flap, flapTe, wing, wingTe);
	planeSection_4.getInputParts().setObjects(flap, flapTe, wing, wingTe);
	planeSection_5.getInputParts().setObjects(flap, flapTe, wing, wingTe);
	planeSection_6.getInputParts().setObjects(flap, flapTe, wing, wingTe);
	planeSection_7.getInputParts().setObjects(flap, flapTe, wing, wingTe);
	planeSection_8.getInputParts().setObjects(flap, flapTe, wing, wingTe);
	planeSection_9.getInputParts().setObjects(flap, flapTe, wing, wingTe);
